...
.. note:: このページの記述はChoreonoidの最新のリリース版である1.6.0および開発版に対しては一部記述が古くなっています。例えば、VC++については当方でビルドを確認したのはバージョン2017となっています。近々記述を更新しますので、最新版に対して正確な説明についてはそれまではお待ちいただくようご了承願います。
